  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        drawer: Drawer(
            child: Menu(
          restartAll: () => context.read(todosProvider.notifier).restartAll(),
          completeAll: () => context.read(todosProvider.notifier).completeAll(),
          removeCompleted: () =>
              context.read(todosProvider.notifier).removeCompleted(),
        )),
